...
import { GoogleAuthProvider, FacebookAuthProvider, TwitterAuthProvider, signInWithEmailAndPassword, signInWithPopup } from "firebase/auth";
        ...
        <form onSubmit={handleEmailLogin}>
          ...
          <CardFooter className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-3 gap-2 w-full">
              <Button type="button" variant="outline" className="border-zinc-800 hover:bg-zinc-900" onClick={() => handleSocialLogin('google')}>
                <GoogleIcon className="h-4 w-4 fill-current" />
              </Button>
              <Button type="button" variant="outline" className="border-zinc-800 hover:bg-zinc-900" onClick={() => handleSocialLogin('facebook')}>
                <FacebookIcon className="h-4 w-4 fill-current" />
              </Button>
              <Button type="button" variant="outline" className="border-zinc-800 hover:bg-zinc-900" onClick={() => handleSocialLogin('twitter')}>
